...
const config: Meta = {
    title: 'web/workflows/WorkflowUpdateForm',
    component: WorkflowUpdateForm,
...
const commonProps: ComponentProps<typeof WorkflowUpdateForm> = {
    ...
    <WebStory>
        {webProps => (
            <MockedStoryProvider mocks={MOCK_REQUESTS}>
                <WorkflowUpdateForm {...webProps} {...commonProps} />
            </MockedStoryProvider>
        )}
    </WebStory>
)
